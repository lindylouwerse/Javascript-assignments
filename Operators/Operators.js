...
numOfDaysUntilWeekend -= 1;
console.log(numOfDaysUntilWeekend);
//3. Show what is, print out. Change what is, print out. 
...
let x = r - 32 + c; // 3
let y = r++ * 4; //16
if(x == 30 || y == 2 ){ // they are both false
...
//TIP: search prompt
let a = 10;
let result = prompt("give a number", default); 
let x = a + result;
let y = a - result; //if prompt is 5 then...
if(x == 15 && y == 5){
    console.log("Yay")
}
